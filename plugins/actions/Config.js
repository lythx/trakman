...
export default {
  ...
  setPlayerPrivilege: {
    ...
    promote: `${p.admin}#{title} ${p.highlight}#{adminNickname}${p.admin} has promoted ` + `${p.highlight}#{nickname}${p.admin} to #{rank}.`,
    demote: `${p.admin}#{title} ${p.highlight}#{adminNickname}${p.admin} has demoted ` + `${p.highlight}#{nickname}${p.admin} to #{rank}.`,
