...
export default {
  ...
  columnProportions: [2, 2],
  cellHeader: ` Player Info `,
  cells: [` Player Login `, ` Player Nickname `, ` Player Nation `, ` Player Privilege `, ` Server Rank `,
    ` Server Average `, ` Total Playtime `, ` Total Records `, ` Total Map Votes `, ` Top Sums `, ` Visits Amount `,
    ` Donations Amount `, ` Wins Amount `, ` Account Type `, ` Last Seen `],
  command: {
