...
export default class PlaytimeRanking extends StaticComponent {
  ...
  constructor() {
    ...
    this.list = new List(this.entries, this.width, this.height - (CFG.staticHeader.height + CFG.marginSmall), CFG.playtimeRanking.columnProportions as any, { background: CFG.static.bgColor })
    this.constructXml()
