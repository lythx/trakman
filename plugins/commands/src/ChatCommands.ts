...
const commands: tm.Command[] = [{
  ...
  callback: (info: tm.MessageInfo, name?: string): void => {
    tm.sendMessage(tm.utils.strVar(config.hi.text, {
      nickname: info.nickname,
      name: name ?? config.defaultValue
    }), config.hi.public ? undefined : info.login, false)
  },
  privilege: config.hi.privilege,
  disableForMuted: true
}, {
  aliases: config.greet.aliases,
  help: config.greet.help,
  params: [],
  callback: (info: tm.MessageInfo): void => {
    let timestamp = tm.players.list[0];
    tm.players.list.slice(1).forEach(player => {
      if (player.joinTimestamp > timestamp.joinTimestamp) {
        timestamp = player
      }
    })
    tm.sendMessage(tm.utils.strVar(config.greet.text, {
      nickname: info.nickname,
      nickname_joiner: timestamp.nickname
    }), config.greet.public ? undefined : info.login, false)
  },
  privilege: config.greet.privilege,
  disableForMuted: true
}, {
  ...
  callback: (info: tm.MessageInfo, name?: string): void => {
    tm.sendMessage(tm.utils.strVar(config.bye.text, {
      nickname: info.nickname,
      name: name ?? config.defaultValue
    }), config.bye.public ? undefined : info.login, false)
  },
  ...
  callback: (info: tm.MessageInfo, name?: string): void => {
    tm.sendMessage(tm.utils.strVar(config.thx.text, {
      nickname: info.nickname,
      name: name ?? config.defaultValue
    }), config.thx.public ? undefined : info.login, false)
  },
  ...
  callback: (info: tm.MessageInfo, name?: string): void => {
    tm.sendMessage(tm.utils.strVar(config.gg.text, {
      nickname: info.nickname,
      name: name ?? config.defaultValue
    }), config.gg.public ? undefined : info.login, false)
  },
  ...
  callback: (info: tm.MessageInfo, name?: string): void => {
    tm.sendMessage(tm.utils.strVar(config.bg.text, {
      nickname: info.nickname,
      name: name ?? config.defaultValue
    }), config.bg.public ? undefined : info.login, false)
  },
  ...
  callback: (info: tm.MessageInfo, name: string): void => {
    tm.sendMessage(tm.utils.strVar(config.n1.text, {
      nickname: info.nickname,
      name: name
    }), config.n1.public ? undefined : info.login, false)
  },
  ...
  callback: (info: tm.MessageInfo, name?: string): void => {
    tm.sendMessage(tm.utils.strVar(config.gr.text, {
      nickname: info.nickname,
      name: name ?? config.defaultValue
    }), config.gr.public ? undefined : info.login, false)
  },
  ...
  callback: (info: tm.MessageInfo): void => {
    tm.sendMessage(tm.utils.strVar(config.bgm.text, { nickname: info.nickname }),
      config.bgm.public ? undefined : info.login, false)
  },
  ...
  callback: (info: tm.MessageInfo): void => {
    tm.sendMessage(tm.utils.strVar(config.brb.text, { nickname: info.nickname }),
      config.brb.public ? undefined : info.login, false)
  },
  ...
  callback: async (info: tm.MessageInfo): Promise<void> => {
    ...
    if (res instanceof Error || res[0] instanceof Error) {
      ...
      tm.sendMessage(tm.utils.strVar(config.afk.text, { nickname: info.nickname }),
        config.afk.public ? undefined : info.login, false)
  ...
  callback: (info: tm.MessageInfo, thoughts?: string): void => {
    tm.sendMessage(tm.utils.strVar(config.me.text, {
      nickname: info.nickname,
      message: thoughts ?? ''
    }), config.me.public ? undefined : info.login, false)
  },
  ...
  callback: (info: tm.MessageInfo): void => {
    tm.sendMessage(tm.utils.strVar(config.lol.text, { nickname: info.nickname }),
      config.lol.public ? undefined : info.login, false)
  },
  ...
  callback: (info: tm.MessageInfo): void => {
    tm.sendMessage(tm.utils.strVar(config.lool.text, { nickname: info.nickname }),
      config.lool.public ? undefined : info.login, false)
  },
  ...
  callback: (info: tm.MessageInfo): void => {
    tm.sendMessage(tm.utils.strVar(config.loool.text, { nickname: info.nickname }),
      config.loool.public ? undefined : info.login, false)
  },
  ...
  callback: (info: tm.MessageInfo): void => {
    tm.sendMessage(tm.utils.strVar(config.bootme.text, { nickname: tm.utils.strip(info.nickname, true) }),
      config.bootme.public ? undefined : info.login)
  ...
  callback: (info: tm.MessageInfo): void => {
    tm.sendMessage(tm.utils.strVar(config.bootme.text, { nickname: tm.utils.strip(info.nickname, true) }),
      config.rq.public ? undefined : info.login)
  ...
  callback: (info: tm.MessageInfo): void => {
    tm.sendMessage(
      tm.utils.strVar(config.playtime.text, { time: tm.utils.getVerboseTime(Date.now() - tm.timer.mapStartTimestamp) }),
      info.login)
  },
  ...
  callback: (info: tm.MessageInfo, commandName: string): void => {
    ...
    for (const e of command) {
      if (e.help === undefined || e.privilege > info.privilege) {
        continue
      }
      str += '\n'
  ...
  callback: async (info: tm.MessageInfo): Promise<void> => {
    ...
    tm.sendMessage(tm.utils.strVar(config.coppers.text, { value: coppers }),
      config.coppers.public ? undefined : info.login)
  },
