...
export class AdministrationService {
  ...
  static removeFromBanlist(login: string): boolean {
  ...
  static removeFromBlacklist(login: string): boolean {
  ...
  static async removeFromMutelist(login: string): Promise<boolean | Error> {
  ...
  static async removeFromGuestlist(login: string): Promise<boolean | Error> {
